...
const ship = game.items.entities.find((i) => i.name === "Shuttle");
...
let chatContent = `<p>Rolling shuttle support - <b>${activeSystem}</b> (${systemScore}) & <b>${activeDepartment}</b> (${departmentScore}) = ${successScore}</p>`;
